...
if (inquiryForm) {
    inquiryForm.addEventListener('submit', function(e) {
        ...
        showNotification('Your inquiry has been submitted successfully! We will contact you soon.', 'success');
        this.reset();
    });
}
...
brandItems.forEach(brand => {
    brand.addEventListener('click', function() {
        ...
        // Show notification
        showNotification(`You selected ${this.textContent}. Contact us for more information!`, 'info');
    });
});
...
const statsObserver = new IntersectionObserver((entries) => {
    entries.forEach(entry => {
        if (entry.isIntersecting && !entry.target.classList.contains('animated')) {
            ...
            const finalValue = parseInt(statValue.textContent.replace('+', ''));
...
document.querySelectorAll('.hero-buttons .btn').forEach(button => {
    button.addEventListener('click', function() {
        if (this.textContent.includes('Start Import')) {
            // Scroll to contact form
            document.getElementById('contact').scrollIntoView({ behavior: 'smooth' });
        } else if (this.textContent.includes('View Available')) {
